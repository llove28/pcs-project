...
- Understand how the mic picks up sounds - some mics allow you to change the pattern, increasing or decreasing the directions it picks up sound from.
    - For a Yeti mic, the best setting will depend on where you and the interviewee are sitting relative to each other (i.e. across from each other, next to each other, etc. 
    - In the U of I Library Studio set, speak into the top of the mic, rather than the sides.
- If you aren’t using the U of I Library Studio to record, you will need to pick a space to record. 
    - Ideally, you want to record in a small room to minimize any echo/reverberation.
...
- Advise them on proper mic etiquette:
    ...
    - The mic should ideally sit about 6 inches from the speaker’s mouth.
        - If this isn’t possible, make sure the mic is picking up the interviewee’s voice well. You may need to increase the gain if they have a light/quiet voice.
    - Limit any fidgeting with papers, pens, etc, as this can muddy the audio.
- Warm up the interviewee by asking them some simple questions as you adjust the equipment and test volume levels (i.e., what did you do over the weekend, what are you looking forward to this summer).
